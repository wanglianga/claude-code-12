...
const routes = [
  { path: '/login', component: () => import('../views/Login.vue') },
  {
    ...
    children: [
      ...
      { path: 'borrows', component: () => import('../views/BorrowList.vue'), meta: { title: '试剂借用' } },
      { path: 'borrows/new', component: () => import('../views/BorrowNew.vue'), meta: { title: '发起跨组借用', roles: ['student'] } },
      { path: 'borrows/:id', component: () => import('../views/BorrowDetail.vue'), meta: { title: '借用详情' } },
